  ...
  return (
    <div className={styles.whatTrumioIsParent}>
      ...
      <div className={styles.frameParent}>
        <div className={`hover:scale-105 transition-all ${styles.frameGroup} `}>
          <div className={styles.aVibrantEcosystemParent}>
            <b className={styles.aVibrantEcosystem}>A Vibrant Ecosystem</b>
            <div className={styles.connectsGlobalClients}>
              Connects global clients with university student and expert teams
              for projects
            </div>
          </div>
          <img
        ...
        <div className={`hover:scale-105 transition-all ${styles.frameContainer}`}>
          <div className={styles.aVirtualWorkbenchParent}>
            <b className={styles.aVirtualWorkbench}>A Virtual Workbench</b>
            <div className={styles.aiEmbeddedThroughout}>
              AI embedded throughout project lifecycle, secure execution
              environment, and expanding tools workbench.
            </div>
          </div>
          <img
            className={styles.exchangeBusinessDocuments1Icon}
            alt=""
            src={group_people2}
          />
        </div>
        <div className={`hover:scale-105 transition-all ${styles.frameDiv}`}>
          <div className={styles.poweredByAiParent}>
            <b className={styles.poweredByAi}>Powered by AI</b>
            <div className={styles.connectsGlobalClients}>
              Enabling emerging talent and entrepreneurs across the world to
